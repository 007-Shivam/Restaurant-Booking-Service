...
export default function CardComponent({ data }) {
    ...
    return (
        <div className='m-40 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 '>
            {data.map((d, index) => (
                <div key={index} className="card-container hover:transform hover:scale-105 hover:transition duration-3000 bg-gradient-to-r from-red-500 to-orange-500">
